    ...
    <>
      ...
      <section className="container">
        ...
        <div className="meaningSection">
          ...
          {dict.meaning2 && <article>2. &nbsp;{dict.meaning2}</article>}
        </div>
        {dict.partOfSpeech1 && (
          <div className="partOfSpeech">
        ...
        <div className="meaningSection">
          {dict.meaning1Verb && <article>1.&nbsp; {dict.meaning1Verb}</article>}
          {dict.synonyms1 && (
            <article className="synonymsDiv">
              <span>Similar:</span>
          ...
          {dict.meaning2Verb && <article>2.&nbsp; {dict.meaning2Verb}</article>}
        </div>
      </section>
    </>
  );
